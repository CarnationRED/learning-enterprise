...
#define CH444G_SW0 36// for old schema, occupies octal psram, new schema: 21
#define CH444G_SW1 35// for old schema, occupies octal psram, new schema: 14
#define CH444G_SWEN 45
#define SWDISABLE() gpio_pullup_en(CH444G_SWEN);gpio_pulldown_dis(CH444G_SWEN);
#define SWENABLE() gpio_pulldown_en(CH444G_SWEN);gpio_pullup_dis(CH444G_SWEN);
